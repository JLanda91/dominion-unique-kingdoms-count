...
def main(output_csv=False):
    ...
    if output_csv:
        ...
        all_factors_gen = (pair_product(all_factors(kingdom_combi, kingdom_factors, non_combi, non_factors)) for (kingdom_combi, kingdom_factors), (non_combi, non_factors) in product(kingdom_gen_with_factors, non_gen_with_factors))
